...
// make movement timing a function of v = V0*a(1 - e^bt)
...
int maxDutyCycleP = 1; // from 0 to 255
int maxDutyCycleV = 1;
int maxDutyCycleH = 1;
int maxDutyCycleD = 1;
int maxDutyCycleA = 1;
...
float timeScalarP = 1.0; // converts physical quantity into movement timing
...
// Step
const int PIN_STEP_MOTOR_P = 2;
const int PIN_STEP_MOTOR_V = 3;
const int PIN_STEP_MOTOR_H = 5;
const int PIN_STEP_MOTOR_D = 6;
const int PIN_STEP_MOTOR_A = 7;
const int PIN_STEP_MOTOR_E = 8;
// Limit Switches
